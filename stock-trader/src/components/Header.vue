<template>
  <v-toolbar app>
    <v-toolbar-title class="headline text-uppercase mr-4">
      <span>Stock <span class="font-weight-light">Trader</span></span>
    </v-toolbar-title>
    <v-toolbar-items>
    ...
    <v-toolbar-items>
      ...
      <v-menu offset-y>
        <v-btn flat slot="activator">Salvar & carregar dados</v-btn>
        <v-list>
          <v-list-tile @click="saveData">
            <v-list-tile-title>Salvar Dados</v-list-tile-title>
          </v-list-tile>
          <v-list-tile @click="loadDataLocal">
            <v-list-tile-title>Carragar Dados</v-list-tile-title>
          </v-list-tile>
        </v-list>
      </v-menu>
